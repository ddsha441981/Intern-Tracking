...
<div class="alert alert-info">
    <h4><strong>Project Manger!</strong> Form:</h4>
  </div>
   ${requestScope.msg}<!-- For Massage -->
<div class="container">
  <form class="form-horizontal" id="signupForm" action="aProjectmanger">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" name="cfpass" placeholder="Enter Confirm Password">
      </div>
    </div>
